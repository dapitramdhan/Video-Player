...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
	...
	*/
	...
	public void onCreate(Bundle bundle) {
		...
		setUpMenu();
		if (bundle == null) {
			getSupportFragmentManager().beginTransaction().replace(R.id.main_fragment, new VideoFragment(), "fragment")
	...
	public void changeFragment(final Fragment fragment) {
		...
		*/
		...
		}.postDelayed(() -> MainActivity.this.getSupportFragmentManager().beginTransaction()
